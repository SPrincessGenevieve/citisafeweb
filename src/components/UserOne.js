    ...
    return (
        <>
            ...
            <div style={{width: "100%", flexDirection:"row", display:"flex"}}>
                ...
                <div style={{marginRight: 40, marginLeft: 40}}>
                    <Selection labelSelect={"Gender"} json={Gender} label={"Gender"}></Selection>
                </div>
            </div>
            <div style={{width: "100%", flexDirection:"row", display:"flex", marginTop: 40}}>
                <div style={{marginRight: 40, marginLeft: 40}}>
                    <Selection labelSelect={"Position"} json={Position} label={"Position"}></Selection>
                </div>
                <div style={{marginRight: 40, marginLeft: 40}}>
            ...
            <div style={{display:"flex", alignItems:"center", justifyContent:"center", marginTop: -200}}>
                <div style={{width: "20%"}}>
                    <ConstButton title={"PROCEED"} height={50} onClick={proceed}></ConstButton>
                </div>
            </div>
        </>
    );
